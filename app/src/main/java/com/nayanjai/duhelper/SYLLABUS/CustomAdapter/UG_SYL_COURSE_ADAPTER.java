...
public class UG_SYL_COURSE_ADAPTER extends RecyclerView.Adapter<UG_SYL_COURSE_ADAPTER.CustomHolder> {

    Context context;
    String[] coursestitle;

    public UG_SYL_COURSE_ADAPTER(Context context, String[] coursestitle) {
    ...
    @NonNull
    @Override
    public UG_SYL_COURSE_ADAPTER.CustomHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ug_syl_courses_listitem,parent,false);
        return new CustomHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UG_SYL_COURSE_ADAPTER.CustomHolder customHolder, int position) {
