...
import com.nayanjai.duhelper.EBOOKS.UG.ADAPTERS.UG_EBK_PAPER_ADAPTER;
...
public class UG_EBK_PAPERS extends AppCompatActivity {

    RecyclerView recyclerView;
    UG_EBK_PAPER_ADAPTER ug_ebk_paper_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ug_ebk_papers);

        recyclerView = findViewById(R.id.ug_ebk_papers_recyclerview);

        Intent i = getIntent();
        String Branch = i.getStringExtra("ebkcoursesclasses");
        Log.d("Branch", "" +Branch);
        ...
        switch (Branch) {
            case "Faculty of Social Sciences":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FSStitle );
                break;

            case "Faculty of Science":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FStitle);
                break;

            case "Faculty of Mathematical Sciences":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FMStitle);
                break;

            case "Faculty of Inter-disciplinary & Applied Sciences":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FIDAStitle);
                break;

            case "Faculty of Commerce & Business Studies":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FCBStitle);
                break;

            case "Faculty of Arts":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FAtitle);
                break;

            case "Faculty of Applied Social Sciences & Humanities":
                ug_ebk_paper_adapter = new UG_EBK_PAPER_ADAPTER(this,FASSHtitle);
                break;
            default:
        ...
        recyclerView.setAdapter(ug_ebk_paper_adapter);
        ;
    }
    }
